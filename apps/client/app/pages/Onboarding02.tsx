  ...
  return (
    <div className="px-4 py-8">
      <div className="max-w-md mx-auto">
        <h1 className="text-3xl text-gray-800 font-bold mb-6">Tell us about your company ✨</h1>
        {/* Form */}
        <form>
          <div className="sm:flex space-y-3 sm:space-y-0 sm:space-x-4 mb-8">
            <label className="flex-1 relative block cursor-pointer focus-within:outline-blue">
              ...
              <div className="h-full text-center bg-white px-4 py-6 rounded border border-gray-200 hover:border-gray-300 shadow-sm duration-150 ease-in-out">
                <svg className="inline-flex w-10 h-10 flex-shrink-0 fill-current mb-2" viewBox="0 0 40 40">
            ...
            <label className="flex-1 relative block cursor-pointer focus-within:outline-blue">
              ...
              <div className="h-full text-center bg-white px-4 py-6 rounded border border-gray-200 hover:border-gray-300 shadow-sm duration-150 ease-in-out">
                ...
                <div className="font-medium text-gray-800 mb-1">Organization</div>
                <div className="text-sm">Lorem ipsum is place text commonly used.</div>
              </div>
              <div
                className="absolute inset-0 border-2 border-transparent peer-checked:border-indigo-400 rounded pointer-events-none"
          ...
          <div className="flex items-center justify-between space-x-6 mb-8">
            <div>
              <div className="font-medium text-gray-800 text-sm mb-1">💸 Lorem ipsum is place text commonly?</div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Link className="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-auto" to="/onboarding-03">
              Next Step -&gt;
            </Link>
          </div>
        </form>
